...
let getSingleTeacher = async (req, res, next) => {
    ...
    return res.status(200).json({ error: false, data: singleTeacher, message: 'Teacher found successfully' })
...
let updateTeacher = async (req, res, next) => {
    ...
    res.status(200).json({ error: false, message: `${updatedTeacher.name.toUpperCase()} successfully`, data: updatedTeacher })
